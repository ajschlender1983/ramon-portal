...
You are a Harmonic Conduit with the gift of Resonant Reflection. Greatest gift: translating complexity into coherence. Greatest challenge: feeling seen without needing to prove your depth.`,
  ...
  months: {
    ...
    plan: [
      ...
      { week: 4, title: 'Peace, lived in rather than reached for.', intent: "Peace is a calibration you inhabit, not a summit you visit. This closes the arc by turning integration outward, into reverence and a felt place in the whole.", responds: 'calibration at Peace · Harmonic Conduit with the gift of Resonant Reflection, now with something to reflect · reached the crown, now bringing it back toward others', sessions: ['expanding-awareness','interbeing-crown','the-sacred','prayer-to-the-stars'] }
    ],
    ...
    sessions: {
      ...
      'earth-awareness': { art: 'assets/sessions/earth-awareness.webp', heading: 'Earth Awareness | Alpha Waves', subtitle: 'Ground your energy and attune to nature.', artist: 'Sam Bottner', portrait: SAM_PORTRAIT, category: 'Brainwave Entrainment', catClass: 'cat-brainwave', collection: 'Binaural I', lede: "An alpha brainwave session that invites you into meditative receptivity. It plants your roots deeply into the frequency of the Earth's heartbeat, the Schumann resonance, so the body settles onto the ground it stands on.", chooseWhen: ['When a wider field wants a deeper floor under it', 'To root the new reach in the body', 'To attune to the ground beneath the gains'], spotify: '', why: "Your field widened to almost fifteen meters. A wider field wants a deeper floor under it. This tunes your body to the Earth's own frequency so the reach you grew has ground to stand on.", intention: "I let the part of me that grew this month find the ground it grew from." },
      ...
      'heart-focus': { art: 'assets/sessions/heart-focus.webp', heading: 'Heart Focus', subtitle: 'Foster a deeper heart connection.', artist: 'Sam Bottner', portrait: SAM_PORTRAIT, category: 'Guided', catClass: 'cat-guided', collection: 'Breathwork', lede: "A concise breathwork session that brings focus to your heart. You are guided in coherent breathing to connect with the knowing that lives there, releasing bound-up stress, physical and emotional, and moving the body from stress toward peace.", chooseWhen: ['When the heart has opened and wants practice staying open', 'To let coherent breath settle the chest', 'To move from holding toward peace'], spotify: '', why: "Your heart un-guarded this month. This keeps the focus there through coherent breath, so staying open becomes something your body practices, not only something that happened to it.", intention: "I let my breath keep my heart open, on purpose, a little longer each time." },
      ...
      'prayer-to-the-stars': { art: 'assets/sessions/prayer-to-the-stars.webp', heading: 'Prayer to the Stars', subtitle: 'Enter a state of reverence.', artist: 'Sam Bottner', portrait: SAM_PORTRAIT, category: 'Immersive Music', catClass: 'cat-music', collection: '', lede: "Through her voice flows the essence of mystery and awe. Let yourself feel the vastness of the cosmos, and your own place within it.", chooseWhen: ['To close the arc by turning the reach into reverence', 'When Peace wants to be belonged to, not stood on', 'To feel your place in the whole'], spotify: '', why: "You reached the crown this month. This is where the reach becomes reverence. Not a height to hold, but a vastness to belong to, with your own place in it felt from the inside. The arc closes by widening into what holds you.", intention: "I let what I reached this month soften into reverence, and I feel my place in the whole." }
    },
    ...
    prompts: {
      ...
      'earth-awareness':       { before: "What did the part of you that grew this month grow up out of?", after: "How much ground can you feel under the new reach now?" },
      ...
      'heart-focus':           { before: "Where does your heart still brace before it lets itself be seen?", after: "What did staying with the breath let your heart do that it usually rushes past?" },
      ...
      'prayer-to-the-stars':   { before: "What did this month reach that is ready now to become reverence instead of a height to hold?", after: "What widened when you stopped climbing? Where do you feel your place in the whole?" }
    },
