...
You are a Harmonic Conduit with the gift of Resonant Reflection. Greatest gift: translating complexity into coherence. Greatest challenge: feeling seen without needing to prove your depth.`,
  ...
  months: {
    ...
    plan: [
      { week: 1, title: 'Land the wider field.', intent: "His field widened and his calibration rose to Peace. A wider field wants a wider floor, or the new reach floats. This week grounds the gains before building on them, so Month 2 starts from settled, not from a high.", responds: 'field widened 13.8 to 14.9m across two re-scans · calibration risen Joy to Peace · crown reached, needs a body that can hold what it reached', sessions: ['morning-star','into-the-earth','coherence-639','luminosity-528'] },
      { week: 2, title: 'Stay in the open throat.', intent: "The throat opened and became his peak. The heart un-guarded. This week returns to both as practice rather than first contact, and puts the will underneath so expression has a spine.", responds: 'truth-throat his highest, a 6, deepened · his Month-1 block, fear of being misunderstood, has moved · heart un-guarded, now practices staying open', sessions: ['liberated-expression','love-heart','centered-power','heart-hara-harmony'] },
      { week: 3, title: 'Crown-direct, from a body that can hold it.', intent: "The sessions held in reserve come in here. He already peaked on 852Hz and reached bridging-worlds unbidden. The crown is met on purpose, paced, received into a grounded body rather than opened wider.", responds: 'three 6s including divine-thread-852 · reached bridging-worlds himself, WOW 5 · lower body grounded and throat-solar axis open, the conditions the reserve was held for', sessions: ['rest-in-love-852','pure-awareness-crown','love-matrix','remember-963'] },
      { week: 4, title: 'Peace, lived in rather than reached for.', intent: "Peace is a calibration you inhabit, not a summit you visit. This closes the arc by turning integration outward, and ends by returning to the session that first showed he was ready.", responds: 'calibration at Peace · Harmonic Conduit with the gift of Resonant Reflection, now with something to reflect · reached the crown, now bringing it back toward others', sessions: ['expanding-awareness','interbeing-crown','the-sacred','bridging-worlds'] }
    ],
