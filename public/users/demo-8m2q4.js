/* User data file for an anonymized demo user.
   ...
   opus-voice subset. Twelve of sixteen sessions are now unique to them
...
You are a Harmonic Conduit with the gift of Resonant Reflection. Greatest gift: translating complexity into coherence. Greatest challenge: feeling seen without needing to prove your depth.`,
  ...
  /* Before / After prompts — pattern-coded for their specific reading. */
  prompts: {
  ...
  /* 4-week plan — curated specifically for their reading, drawing from the
  ...
  /* Held in reserve — every one is a session that would feed their
