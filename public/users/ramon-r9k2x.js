...
You are functioning as a Harmonic Guardian of the Inner Return. Your greatest gift is the ability to hold a mirror of coherence so precise that others cannot remain fragmented in your presence. Your greatest challenge: to believe you are already what you seek to become.`,
  ...
  plan: [
    { week: 1, title: 'In the Body', intent: "Ground first. Don't pile crown content on a system already oversaturated.", responds: 'Root undercharged · third-eye filtering more data than usual · "minor echo of unworthiness in lower chakras" · new to SoundBed', sessions: ['welcome-to-opus','stability-root','earth-awareness','body-scan'] },
    { week: 2, title: 'Release the Charge', intent: "Make room. Let the body unload what it's already finished with.", responds: 'Liver detox wave · kidneys recovering / fear-based residue · "fear of timeline collapse" as primary block', sessions: ['fearless-396','ease-174','fire-cleanse','sending-mark-home'] },
